...
def getBattleLogShellTypesNames():
  ...
  try: 
    BATTLE_LOG_SHELL_TYPES_NAMES[BATTLE_LOG_SHELL_TYPES.FLAME] = 'FLAME'
    BATTLE_LOG_SHELL_TYPES_NAMES[BATTLE_LOG_SHELL_TYPES.ARMOR_PIERCING_FSDS] = 'ARMOR_PIERCING_FSDS'
    BATTLE_LOG_SHELL_TYPES_NAMES[BATTLE_LOG_SHELL_TYPES.HOLLOW_CHARGE_DF] = 'HOLLOW_CHARGE_DF'
    BATTLE_LOG_SHELL_TYPES_NAMES[BATTLE_LOG_SHELL_TYPES.ARMOR_PIERCING_DF] = 'ARMOR_PIERCING_DF'
    BATTLE_LOG_SHELL_TYPES_NAMES[BATTLE_LOG_SHELL_TYPES.ARMOR_PIERCING_HE_DF] = 'ARMOR_PIERCING_HE_DF'
    BATTLE_LOG_SHELL_TYPES_NAMES[BATTLE_LOG_SHELL_TYPES.ARMOR_PIERCING_CR_DF] = 'ARMOR_PIERCING_CR_DF'
    BATTLE_LOG_SHELL_TYPES_NAMES[BATTLE_LOG_SHELL_TYPES.HE_MODERN_DF] = 'HE_MODERN_DF'
