...
# CEFPYTHON3_DIR = get_package_paths("cpython3")[1]
CEFPYTHON3_DIR = os.path.join(os.path.dirname(__file__), "src", "cefpython3")
...
def get_cefpython_modules():
    ...
    'cefpython_py27'. """
    return ['cefpython3\\cefpython_py37']
    pyds = glob.glob(os.path.join(CEFPYTHON3_DIR, "cefpython_py*" + CYTHON_MODULE_EXT))
    print(pyds)
    print(os.path.join(CEFPYTHON3_DIR, "cefpython_py*" + CYTHON_MODULE_EXT))
